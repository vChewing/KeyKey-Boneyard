...
#define XML_ParserCreate_MM(encoding, memsuite, namespaceSeparator) \
  IExpat->XML_ParserCreate_MM(encoding, memsuite, namespaceSeparator)
#define XML_ExternalEntityParserCreate(parser, context, encoding) \
  IExpat->XML_ExternalEntityParserCreate(parser, context, encoding)
#define XML_ParserFree(parser) IExpat->XML_ParserFree(parser)
#define XML_Parse(parser, s, len, isFinal) \
  IExpat->XML_Parse(parser, s, len, isFinal)
#define XML_ParseBuffer(parser, len, isFinal) \
  IExpat->XML_ParseBuffer(parser, len, isFinal)
#define XML_GetBuffer(parser, len) IExpat->XML_GetBuffer(parser, len)
#define XML_SetStartElementHandler(parser, start) \
  IExpat->XML_SetStartElementHandler(parser, start)
#define XML_SetEndElementHandler(parser, end) \
  IExpat->XML_SetEndElementHandler(parser, end)
#define XML_SetElementHandler(parser, start, end) \
  IExpat->XML_SetElementHandler(parser, start, end)
#define XML_SetCharacterDataHandler(parser, handler) \
  IExpat->XML_SetCharacterDataHandler(parser, handler)
#define XML_SetProcessingInstructionHandler(parser, handler) \
  IExpat->XML_SetProcessingInstructionHandler(parser, handler)
#define XML_SetCommentHandler(parser, handler) \
  IExpat->XML_SetCommentHandler(parser, handler)
#define XML_SetStartCdataSectionHandler(parser, start) \
  IExpat->XML_SetStartCdataSectionHandler(parser, start)
#define XML_SetEndCdataSectionHandler(parser, end) \
  IExpat->XML_SetEndCdataSectionHandler(parser, end)
#define XML_SetCdataSectionHandler(parser, start, end) \
  IExpat->XML_SetCdataSectionHandler(parser, start, end)
#define XML_SetDefaultHandler(parser, handler) \
  IExpat->XML_SetDefaultHandler(parser, handler)
#define XML_SetDefaultHandlerExpand(parser, handler) \
  IExpat->XML_SetDefaultHandlerExpand(parser, handler)
#define XML_SetExternalEntityRefHandler(parser, handler) \
  IExpat->XML_SetExternalEntityRefHandler(parser, handler)
#define XML_SetExternalEntityRefHandlerArg(parser, arg) \
  IExpat->XML_SetExternalEntityRefHandlerArg(parser, arg)
#define XML_SetUnknownEncodingHandler(parser, handler, data) \
  IExpat->XML_SetUnknownEncodingHandler(parser, handler, data)
#define XML_SetStartNamespaceDeclHandler(parser, start) \
  IExpat->XML_SetStartNamespaceDeclHandler(parser, start)
#define XML_SetEndNamespaceDeclHandler(parser, end) \
  IExpat->XML_SetEndNamespaceDeclHandler(parser, end)
#define XML_SetNamespaceDeclHandler(parser, start, end) \
  IExpat->XML_SetNamespaceDeclHandler(parser, start, end)
#define XML_SetXmlDeclHandler(parser, handler) \
  IExpat->XML_SetXmlDeclHandler(parser, handler)
#define XML_SetStartDoctypeDeclHandler(parser, start) \
  IExpat->XML_SetStartDoctypeDeclHandler(parser, start)
#define XML_SetEndDoctypeDeclHandler(parser, end) \
  IExpat->XML_SetEndDoctypeDeclHandler(parser, end)
#define XML_SetDoctypeDeclHandler(parser, start, end) \
  IExpat->XML_SetDoctypeDeclHandler(parser, start, end)
#define XML_SetElementDeclHandler(parser, eldecl) \
  IExpat->XML_SetElementDeclHandler(parser, eldecl)
#define XML_SetAttlistDeclHandler(parser, attdecl) \
  IExpat->XML_SetAttlistDeclHandler(parser, attdecl)
#define XML_SetEntityDeclHandler(parser, handler) \
  IExpat->XML_SetEntityDeclHandler(parser, handler)
#define XML_SetUnparsedEntityDeclHandler(parser, handler) \
  IExpat->XML_SetUnparsedEntityDeclHandler(parser, handler)
#define XML_SetNotationDeclHandler(parser, handler) \
  IExpat->XML_SetNotationDeclHandler(parser, handler)
#define XML_SetNotStandaloneHandler(parser, handler) \
  IExpat->XML_SetNotStandaloneHandler(parser, handler)
...
#define XML_GetCurrentLineNumber(parser) \
  IExpat->XML_GetCurrentLineNumber(parser)
#define XML_GetCurrentColumnNumber(parser) \
  IExpat->XML_GetCurrentColumnNumber(parser)
#define XML_GetCurrentByteCount(parser) IExpat->XML_GetCurrentByteCount(parser)
#define XML_GetInputContext(parser, offset, size) \
  IExpat->XML_GetInputContext(parser, offset, size)
#define XML_SetUserData(parser, userData) \
...
#define XML_UseParserAsHandlerArg(parser) \
  IExpat->XML_UseParserAsHandlerArg(parser)

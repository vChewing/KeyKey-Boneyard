...
TEST(PassingTestHasNoFailures) {
  class PassingTest : public Test {
   public:
    ...
    virtual void RunImpl(TestResults& testResults_) const { CHECK(true); }
  };
...
TEST(FailingTestHasFailures) {
  class FailingTest : public Test {
   public:
    ...
    virtual void RunImpl(TestResults& testResults_) const { CHECK(false); }
  };
...
TEST(ThrowingTestsAreReportedAsFailures) {
  class CrashingTest : public Test {
   public:
    ...
    virtual void RunImpl(TestResults&) const { throw "Blah"; }
  };

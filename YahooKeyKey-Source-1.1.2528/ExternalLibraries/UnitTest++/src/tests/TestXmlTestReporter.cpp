...
TEST_FIXTURE(XmlTestReporterFixture, MultipleCharactersAreEscaped) {
  ...
  char const* expected =
      "<?xml version=\"1.0\"?>"
      "<unittest-results tests=\"1\" failedtests=\"2\" failures=\"3\" "
      "time=\"0.1\">"
...
TEST_FIXTURE(XmlTestReporterFixture, EmptyReportSummaryFormat) {
  ...
  const char* expected =
      "<?xml version=\"1.0\"?>"
      "<unittest-results tests=\"0\" failedtests=\"0\" failures=\"0\" "
      "time=\"0.1\">"
      "</unittest-results>";
...
TEST_FIXTURE(XmlTestReporterFixture, SingleSuccessfulTestReportSummaryFormat) {
  ...
  const char* expected =
      "<?xml version=\"1.0\"?>"
      "<unittest-results tests=\"1\" failedtests=\"0\" failures=\"0\" "
      "time=\"0.1\">"
...
TEST_FIXTURE(XmlTestReporterFixture, SingleFailedTestReportSummaryFormat) {
  ...
  const char* expected =
      "<?xml version=\"1.0\"?>"
      "<unittest-results tests=\"1\" failedtests=\"1\" failures=\"1\" "
      "time=\"0.1\">"
...
TEST_FIXTURE(XmlTestReporterFixture, OneFailureAndOneSuccess) {
  ...
  char const* expected =
      "<?xml version=\"1.0\"?>"
      "<unittest-results tests=\"2\" failedtests=\"1\" failures=\"1\" "
      "time=\"1.1\">"
...
TEST_FIXTURE(XmlTestReporterFixture, MultipleFailures) {
  ...
  char const* expected =
      "<?xml version=\"1.0\"?>"
      "<unittest-results tests=\"1\" failedtests=\"1\" failures=\"2\" "
      "time=\"1.1\">"
      "<test suite=\"suite\" name=\"FailedTest\" time=\"0.1\">"
      "<failure message=\"fail.h(1) : expected 1 but was 2\"/>"

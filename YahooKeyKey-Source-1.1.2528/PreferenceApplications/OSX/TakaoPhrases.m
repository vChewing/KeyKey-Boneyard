...
- (IBAction)exportDatabaseToDotMac:(id)sender {
  ...
  // informativeTextWithFormat:LFLSTR(@"If you are not runnung Yahoo! KeyKey,
  ...
  // toPath:@"/Documents/Yahoo! KeyKey Phrases.txt"]; 		if
...
- (IBAction)importDatabaseFromDotMac:(id)sender {
  ...
  //*downloadTransaction = [mySession getDataAtPath:@"/Documents/Yahoo! KeyKey
...
// case kDMResourceNotFound: 			errorDescription = LFLSTR(@"Yahoo! KeyKey user
